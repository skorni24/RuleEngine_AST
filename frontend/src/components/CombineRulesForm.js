    ...
    return (
        <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label htmlFor="ruleIds" className="block text-sm font-medium text-gray-700 mb-2">Rule IDs (comma-separated)</label>
                    <input
                        id="ruleIds"
                        type="text"
                        value={ruleIds.join(',')}
                ...
                <div>
                    <label htmlFor="operator" className="block text-sm font-medium text-gray-700 mb-2">Operator</label>
                    <select
                        id="operator"
                        value={operator}
